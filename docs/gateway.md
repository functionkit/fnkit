...
The gateway includes a built-in Bun-based orchestrator for multi-function pipelines, accessed via the `/orchestrate/<name>` route. See the full [Orchestrator documentation](orchestrator.md) for details on sequential and parallel pipelines, managing pipelines, and configuration.
...
| `orchestrator/package.json` | Orchestrator dependencies (ioredis)                 |
...
← [Back to README](../README.md) · [Orchestrator →](orchestrator.md) · [Cache →](cache.md) · [Commands →](commands.md)
